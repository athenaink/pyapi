...
class PiqLog:
    ...
    def write(self, img_url, _hash, hash_match_num, down_time, db_time, sim_time, total_time, repeat, sim, cid, aid):
        sql = """INSERT INTO {}(img_url,
                    hash, hash_match_num, down_time, db_time, sim_time, total_time, `repeat`, sim, cid, aid)
                    VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')""".format(db_cfg['table_log'], img_url, _hash, hash_match_num, int(down_time*1000), int(db_time*1000), int(sim_time*1000), int(total_time*1000), repeat, sim, cid, aid)
